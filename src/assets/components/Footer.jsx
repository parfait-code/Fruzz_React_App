  ...
  return (
    <footer
      ...
      <div className="max-w-screen-lg text-gray-400 mx-auto py-3">
        ...
        <section
          ...
          <div className=" rounded-lg bg-slate-700 space-y-3 px-6 py-6  text-white sm:w-1/2 " >
            ...
            >
              ...
              <input className="w-full mt-3 bg-slate-600 shadow py-3 px-5 rounded-lg" type="email" name="" id="email" placeholder="Enter your email" /><br />
              <div className="mt-3">
                <label htmlFor="email">Message</label><br />
                <input className="w-full h-16 mt-3 px-5  bg-slate-600 shadow rounded-lg" type="textarea" name="" id="message" placeholder="What are you say?" /><br />
              </div>
        ...
        <section className="space-y-6 mx-6 py-6">
          <div className=" space-y-6 ">
            <h4 className=" text-primary text-4xl font-bold">BICCAS</h4>
            <p>Get started now try our product</p>
            <div className=" flex w-full justify-between pl-3 pr-1 py-1 items-center  border border-primary rounded-full hover:scale-105">
